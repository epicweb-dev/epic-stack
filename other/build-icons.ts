...
async function generateIconFiles() {
	...
	const iconNameOutputFilepath = path.join(outputDir, 'name.ts')
	...
	const namesChanged = await writeIfChanged(
		iconNameOutputFilepath,
		iconNameOutputContent,
	)

	logVerbose(`Icon names saved to ${path.relative(cwd, iconNameOutputFilepath)}`)
	...
	if (spriteChanged || typesChanged || readmeChanged || namesChanged) {
