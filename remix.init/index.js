...
const main = async ({ isTypeScript, rootDirectory }) => {
	if (!isTypeScript) {
		...
		throw `Sorry, this template only supports TypeScript. Please run the command again and select "TypeScript". Learn more about why in https://github.com/epicweb-dev/epic-stack/blob/decisions/01-typescript-only.md`
	}
