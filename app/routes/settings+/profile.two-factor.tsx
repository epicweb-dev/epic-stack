		...
		<Dialog.Root open={true}>
			<Dialog.Portal>
				...
				<Dialog.Content
					...
					className="fixed left-1/2 top-1/2 max-h-full w-[90vw] max-w-3xl -translate-x-1/2 -translate-y-1/2 transform overflow-y-scroll rounded-lg bg-muted-500 p-12 shadow-lg"
				>
