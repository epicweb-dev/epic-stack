		...
		<DropdownMenu>
			<DropdownMenuTrigger asChild>
				<Link
					...
					className="radix-state-open:bg-night-400 flex items-center gap-2 rounded-full bg-night-500 py-2 pl-2 pr-4 outline-none hover:bg-night-400 focus:bg-night-400"
				>
					<img
			...
			<DropdownMenuContent
				sideOffset={8}
				align="start"
				className="flex flex-col rounded-xl bg-[#323232] text-white"
			>
				<DropdownMenuItem asChild>
					<Link
						prefetch="intent"
						to={`/users/${user.username}`}
						className="radix-highlighted:bg-night-500 rounded-b-3xl px-3 py-1 outline-none"
					>
						Profile
					</Link>
				</DropdownMenuItem>
