		...
		<DropdownMenu.Root>
			<DropdownMenu.Trigger asChild>
				<Link
					...
					className="flex items-center gap-2 rounded-full bg-muted-500 py-2 pl-2 pr-4 outline-none hover:bg-muted-400 focus:bg-muted-400 radix-state-open:bg-muted-400"
				>
					<img
			...
			<DropdownMenu.Portal>
				<DropdownMenu.Content
					sideOffset={8}
					align="start"
					className="flex flex-col rounded-3xl border bg-background shadow-lg outline-none"
				>
					<DropdownMenu.Item asChild>
						<Link
							prefetch="intent"
							to={`/users/${user.username}`}
							className="rounded-t-3xl px-7 py-5 outline-none hover:bg-muted-500 radix-highlighted:bg-muted-500"
						>
							Profile
						</Link>
					</DropdownMenu.Item>
					<DropdownMenu.Item asChild>
						<Link
							...
							className="px-7 py-5 outline-none hover:bg-muted-500 radix-highlighted:bg-muted-500"
						>
							Notes
						</Link>
					</DropdownMenu.Item>
