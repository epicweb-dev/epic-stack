		...
		<DropdownMenu.Root>
			<DropdownMenu.Trigger asChild>
				<Link
					...
					className="bg-muted-500 hover:bg-muted-400 focus:bg-muted-400 radix-state-open:bg-muted-400 flex items-center gap-2 rounded-full py-2 pl-2 pr-4 outline-none"
				>
					<img
				...
				>
					<DropdownMenu.Item asChild>
						<Link
							prefetch="intent"
							to={`/users/${user.username}`}
							className="hover:bg-muted-500 radix-highlighted:bg-muted-500 rounded-t-3xl px-7 py-5 outline-none"
						>
							Profile
						</Link>
					</DropdownMenu.Item>
					<DropdownMenu.Item asChild>
						<Link
							...
							className="hover:bg-muted-500 radix-highlighted:bg-muted-500 px-7 py-5 outline-none"
						>
							Notes
						</Link>
					</DropdownMenu.Item>
					<DropdownMenu.Item asChild>
						<Form
							action="/logout"
							method="POST"
							className="radix-highlighted:bg-muted-500 rounded-b-3xl px-7 py-5 outline-none"
